...
public class TableController implements Initializable {
    ...
    @FXML
    private TableColumn<Employee, ?> colSelect, colId, colName, colStatus, colActions;
    ...
    private void loadTable() {
        ...
        employees.add(new Employee(table, 1, "Houari", true));
        employees.add(new Employee(table, 2, "Moh", false));
        employees.add(new Employee(table, 3, "Fatima", true));
