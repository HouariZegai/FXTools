package com.houarizegai.fxtools.reports.java_object_datasource;
...
public class JasperReportDemo {
    ...
    private void openReport() {
    	try {
	    	String path = "src\\com\\houarizegai\\fxtools\\reports\\java_object_datasource\\FactureClient.jrxml";
