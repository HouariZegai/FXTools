package com.houarizegai.javafxtools.menus.model1;
...
public class MenuController implements Initializable {
    ...
    private void sliderAutoChangePictures() {
        ...
        Timeline sliderTimer = new Timeline(new KeyFrame(Duration.ZERO, e -> {
            ...
            ft.play();
            imgSlider.setImage(new Image("com/houarizegai/javafxtools/menus/model1/img/slider/" + counter + ".png"));
    ...
    private void onTitle1() {
        styleBox(1);
        try {
            ItemPane = FXMLLoader.load(getClass().getResource("/com/houarizegai/javafxtools/menus/model1/ItemPane.fxml"));
    ...
    private void onTitle2() {
        styleBox(2);
        try {
            ItemPane = FXMLLoader.load(getClass().getResource("/com/houarizegai/javafxtools/menus/model1/RightPane.fxml"));
        } catch (IOException ioe) {
            ioe.printStackTrace();
        }
        setNode(ItemPane);
